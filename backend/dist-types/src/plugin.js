...
exports.progressive_deliveryPlugin = void 0;
 ...
 * @public
 */
exports.progressive_deliveryPlugin = (0, backend_plugin_api_1.createBackendPlugin)({
    ...
    register: function (env) {
        env.registerInit({
            ...
            init: function (_a) {
                var httpRouter = _a.httpRouter, logger = _a.logger, config = _a.config;
                return __awaiter(this, void 0, void 0, function () {
                    var _b, _c;
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0:
                                _c = (_b = httpRouter).use;
